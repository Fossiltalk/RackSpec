...
var PALETTE = {
  ...
  // PMS 293 C, FS 15095
  "ultramarine-blue": "#003087",
  // FS 15090 — Army/Navy ribbon blue
  "bluebird": "#5B8DB8",
  // FS 15121 — medium cornflower blue (Defense medals)
  "grotto-blue": "#1D4B8B",
  // Deep royal blue (Coast Guard DSM)
  "navy-blue": "#000080",
  // Standard navy blue
  "sky-blue": "#87CEEB",
  // Light sky blue
  ...
  // PMS 356 C, FS 14110
  "irish-green": "#009A44",
  // PMS 347 C — EAME Campaign, vivid green
  "primitive-green": "#4A6130",
  // FS 34077 — olive/jungle green, Vietnam Service
  // ─── Yellows / Golds ────────────────────────────────────────────────────────
  "golden-yellow": "#FDD017",
  // PMS 116 C, FS 13655
  "air-force-yellow": "#FFD100",
  // PMS 109 C — lighter AF/SSF yellow
  "gold": "#C5A028",
  // PMS 871 C, FS 13538 — metallic gold
  "golden-orange": "#D97B0E",
  // Warm golden-orange (Air Medal stripes)
  "chamois": "#C8A96E",
  // FS 20219 — tan/buff (Iraq Campaign center)
  // ─── Reds / Purples ─────────────────────────────────────────────────────────
  "purple-heart-purple": "#7851A9",
  // "Old orchid" — Purple Heart ribbon
  "purple-violet": "#4B2D7F",
  // Deeper violet/purple
  // ─── Earth / Neutrals ───────────────────────────────────────────────────────
  "earth-brown": "#826644",
  // Earth tone (EAME Campaign edges)
  "persian-orange": "#DC7B39",
  // Orange (MFO Medal)
  "buff": "#F0DC82",
  // Light buff/straw
  // ─── Monochrome ─────────────────────────────────────────────────────────────
...
exports.RackSpecParseError = RackSpecParseError;
exports.STUB_RIBBONS = STUB_RIBBONS;
exports.getDefaultRegistry = getDefaultRegistry;
exports.loadRegistry = loadRegistry;
exports.mergeRegistry = mergeRegistry;
exports.parse = parse;
exports.render = renderSpec;
